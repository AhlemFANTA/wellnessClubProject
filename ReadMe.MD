...
Pour se connecter en tant qu'administrateur du blog utiliser l'@mail et le mot de passe par défaut ci-dessous ; (une fois connecté, vous pouvez créer votre propre compte)  
