...
class RegistrationType extends ApplicationType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('passwordConfirm', PasswordType::class, $this->getConfiguration("Confirmation Mot de passe", "Veuillez confirmez votre mot de passe..."))//  ->add('instroduction', TextType::class,$this->getConfiguration("Introduction ", "Presentez vous en quelque mot..."))
